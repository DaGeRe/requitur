...
public class TestSequitur {
   ...
   public void testBasic() {
      ...
      final List<Content> expandedTrace = ContentTraceExpander.expandContentTrace(trace, seq.getRules());
   ...
   public void testUnitRules() {
      ...
      final List<Content> expandedTrace = ContentTraceExpander.expandContentTrace(seq.getUncompressedTrace(), seq.getRules());
